...
export function MenuItemModal({ item, onClose, categories }: MenuItemModalProps) {
              ...
              {recipe.map((ingredient, index) => (
                ...
                >
                  <select
                    ...
                    onChange={(e) =>
                      handleRecipeChange(index, 'inventory_item_id', e.target.value)
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-md"
                    required
                  >
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleRecipeChange(index, 'quantity_used', e.target.value)
                    }
