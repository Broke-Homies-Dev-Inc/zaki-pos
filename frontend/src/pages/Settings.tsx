            ...
            <div className="bg-white rounded-lg shadow-sm">
                ...
                >
                    <div>
                        ...
                        <p className="text-sm text-gray-500">
                            Configure restaurant name, address, phone,
                            registration number, and tax rate.
                        </p>
                    </div>
                ...
                >
                    <div>
                        ...
                        <p className="text-sm text-gray-500">
                            Configure loyalty points system and rewards for
                            customers.
                        </p>
                    </div>
                    <ChevronRight size={20} className="text-gray-400" />
                ...
                >
                    <div>
                        ...
                        <p className="text-sm text-gray-500">
                            Configure print preview and PDF saving options for
                            bills.
                        </p>
                    </div>
                    <ChevronRight size={20} className="text-gray-400" />
                ...
                >
                    <div>
                        ...
                        <p className="text-sm text-gray-500">
                            Manage floors, sections, and tables for your
                            restaurant.
                        </p>
                    </div>
                    <ChevronRight size={20} className="text-gray-400" />
