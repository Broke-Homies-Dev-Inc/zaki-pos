...
async function setupLoyaltySystem() {
  ...
  try {
    ...
    console.log('   ✅ Added loyalty_points_per_100 column (default: 10 points per OMR100)');
    ...
    if (config.rows.length > 0) {
      ...
      console.log(`   Points per OMR100: ${config.rows[0].loyalty_points_per_100}`);
    }
    ...
    console.log('   3. Configure points per OMR100 spent');
